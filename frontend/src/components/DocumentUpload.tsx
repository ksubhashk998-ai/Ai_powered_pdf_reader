      ...
      {activeDoc && (
        <div className="flex items-center justify-between p-4 rounded-xl bg-slate-900 border border-emerald-500/30">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm font-semibold text-slate-100">Document Scanned & Ready: {activeDoc.title}</p>
              <p className="text-xs text-slate-400">
                {pyqDoc ? `PYQ Paper Linked: ${pyqDoc.title}` : '18+ Exam questions & multi-section model answers ready!'}
              </p>
            </div>
          </div>
